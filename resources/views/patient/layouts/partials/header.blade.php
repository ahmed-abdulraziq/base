            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        <div class="mt-1 small text-secondary">@lang('translate.patient')</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('patient.home') }}" class="dropdown-item">
                        <span class="nav-link-icon me-2">@lang('translate.home')</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('dashboard.logout') }}"
                        onclick="event.preventDefault();
                      document.getElementById('patient-logout-form').submit();"
                        class="dropdown-item">
                    ...
                    <form id="patient-logout-form" action="{{ route('dashboard.logout') }}" method="POST" style="display: none;">@csrf</form>
                </div>
            </div>
        </div>
    </div>
