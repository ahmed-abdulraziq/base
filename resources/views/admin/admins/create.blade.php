...
@section('title', __('translate.create_admin'))
@section('header', __('translate.create_admin'))
@section('admins', 'active')
@section('breadcrumbs', Breadcrumbs::render('admins.create'))

@section('content')
    <div class="col-md-12">
        <x-forms.form route="dashboard.admins.store" method="POST" submitText="{{ __('translate.save') }}" formClass="form-horizontal" :title="__('translate.create_admin')">
