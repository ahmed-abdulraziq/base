...
@section('breadcrumbs', Breadcrumbs::render('doctor.employees.edit', $employee))

@section('content')
    <div class="col-md-12">
        <x-forms.form route="doctor.employees.update" :model="$employee" method="PUT" submitText="{{ __('translate.save') }}" formClass="form-horizontal" :title="__('translate.edit_employee')">
