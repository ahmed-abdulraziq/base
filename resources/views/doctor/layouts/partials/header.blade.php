...
<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
    <div class="container-xl">
        ...
        <div class="nav-item d-none d-md-flex me-3">
            <a href="{{ route('doctor.prescriptions.create') }}" class="btn " title="{{ __('translate.create_prescription') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon me-2"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
                {{ __('translate.create_prescription') }}
            </a>
        </div>
        ...
        <div class="navbar-nav flex-row ms-auto">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm rounded-circle" @if($doctorUser->avatar ?? null) style="background-image: url('{{ $doctorUser->avatar }}')" @endif>
                        @unless($doctorUser->avatar ?? null)
                    ...
                    <div class="d-none d-xl-block ps-2">
                        <div>{{ $doctorUser->full_name ?? $doctorUser->name ?? '' }}</div>
                        <div class="mt-1 small text-secondary">@lang('translate.doctor')</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">

                    <div class="dropdown-divider"></div>
                    <a href="{{ route('doctor.home') }}" class="dropdown-item">
                    ...
                    <form id="doctor-logout-form" action="{{ route('doctor.logout') }}" method="POST" style="display: none;">@csrf</form>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="navbar">
            <div class="container-xl">
                <div class="row flex-fill align-items-center">
                    <div class="col">
                        <ul class="navbar-nav">
                            <li class="nav-item @yield('doctor_home', '')">
                                <a class="nav-link" href="{{ route('doctor.home') }}">
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 12l-2 0l9 -9l9 9l-2 0" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                                    </span>
                                    <span class="nav-link-title">@lang('translate.home')</span>
                                </a>
                            </li>
                            <li class="nav-item @yield('doctor_appointments', '')">
                            ...
                            <li class="nav-item @yield('doctor_prescriptions', '')">
                                <a class="nav-link" href="{{ route('doctor.prescriptions.index') }}">
                                    <span class="nav-link-icon">
                            ...
                            <li class="nav-item @yield('doctor_examinations', '')">
                                <a class="nav-link" href="{{ route('doctor.examinations.index') }}">
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M9 12h6" /><path d="M9 16h6" /></svg>
                                    </span>
                                    <span class="nav-link-title">@lang('translate.medical_examinations')</span>
                                </a>
                            </li>
                            <li class="nav-item @yield('doctor_patients', '')">
                                <a class="nav-link" href="{{ route('doctor.patients.index') }}">
                                    <span class="nav-link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h1.5" /><path d="M18 22l3.35 -3.284a2.143 2.143 0 0 0 .005 -3.071a2.242 2.242 0 0 0 -3.129 -.006l-.224 .22l-.223 -.22a2.242 2.242 0 0 0 -3.128 -.006a2.143 2.143 0 0 0 -.006 3.071l3.355 3.296z" /></svg>
                                    </span>
                                    <span class="nav-link-title">@lang('translate.patients')</span>
                                </a>
                            </li>
                            <li class="nav-item @yield('doctor_employees', '')">
                                <a class="nav-link" href="{{ route('doctor.employees.index') }}">
                                    <span class="nav-link-icon">
