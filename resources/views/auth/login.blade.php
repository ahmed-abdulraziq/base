...
@section('title', __('translate.login'))
@section('content')
    @php
    ...
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.login') }}" method="POST" autocomplete="off" novalidate="">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                            ...
                            placeholder="{{ __('translate.email') }}" autocomplete="off">
                        @error('email')
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" class="form-control  @error('password') is-invalid @enderror"
                                placeholder="{{ __('translate.password') }}" name="password" required
            ...
            <div class="card-body">
                <div class="row">
                  <div class="col">
                    <a href="{{ route('dashboard.login.google') }}" class="btn btn-4 w-100">
                      ...
                      <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-google"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M20.945 11a9 9 0 1 1 -3.284 -5.997l-2.655 2.392a5.5 5.5 0 1 0 2.119 6.605h-4.125v-3h7.945z" /></svg>
                        @lang('translate.login_with_google')
        ...
        <div class="text-center text-secondary mt-3">
            ...
            <a href="{{ route('dashboard.register') }}" tabindex="-1">
