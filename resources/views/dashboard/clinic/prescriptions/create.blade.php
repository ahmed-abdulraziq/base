...
@section('breadcrumbs', Breadcrumbs::render('clinic.prescriptions.create'))

@section('content')
    <div class="col-md-12">
        <form action="{{ route('dashboard.clinic.prescriptions.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
                <div class="mb-3">
