<div style="width: fit-content; display: flex; align-items: center;">
    <a href="{{ route('dashboard.clinic.doctors.edit', $item->doctor_id) }}" class="text-primary p-1 mx-1 fs-6">
    ...
    <a href="javascript:void(0)" role="button" class="text-danger p-1 m-1 delete-btn cursor-pointer" data-url="{{ route('dashboard.clinic.doctors.destroy', $item->doctor_id) }}">
