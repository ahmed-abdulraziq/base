...
@section('content')
    <div class="col-md-12">
        <x-forms.form route="dashboard.clinic.specializations.update" :model="$specialization->specialization_id" method="PUT" submitText="{{ __('translate.save') }}" formClass="form-horizontal" :title="__('translate.edit_specialization')">
