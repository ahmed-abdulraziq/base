...
@section('content')
    <div class="col-md-12">
        <x-forms.form route="dashboard.clinic.appointments.update" :model="$appointment->appointment_id" method="PUT" submitText="{{ __('translate.save') }}" formClass="form-horizontal" :title="__('translate.edit_appointment')">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="status" class="form-select" required>
                    @foreach(['محجوز', 'مؤكد', 'منتهي', 'ملغي'] as $s)
