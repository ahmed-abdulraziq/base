<div class="settings">
    ...
    <form class="offcanvas offcanvas-start offcanvas-narrow" tabindex="-1" id="offcanvasSettings">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title">@lang('translate.theme_settings')</h2>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="@lang('translate.close')"></button>
        </div>
        <div class="offcanvas-body d-flex flex-column">
            <div>
                <div class="mb-4">
                    <label class="form-label">@lang('translate.color_mode')</label>
                    <p class="form-hint">@lang('translate.color_mode_hint')</p>
                    <label class="form-check">
                        <div class="form-selectgroup-item">
                            <input type="radio" name="theme" value="light" class="form-check-input" checked />
                            <div class="form-check-label">@lang('translate.light')</div>
                        </div>
                    </label>
                    <label class="form-check">
                        <div class="form-selectgroup-item">
                            <input type="radio" name="theme" value="dark" class="form-check-input" />
                            <div class="form-check-label">@lang('translate.dark')</div>
                        </div>
                    </label>
                </div>
                <div class="mb-4">
                    <label class="form-label">@lang('translate.color_scheme')</label>
                    <p class="form-hint">@lang('translate.color_scheme_hint')</p>
                    <div class="row g-2">
                        <div class="col-auto">
                ...
                <div class="mb-4">
                    <label class="form-label">@lang('translate.font_family')</label>
                    <p class="form-hint">@lang('translate.font_family_hint')</p>
                    <div>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-font" value="sans-serif" class="form-check-input"
                                    checked />
                                <div class="form-check-label">@lang('translate.sans_serif')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-font" value="serif" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.serif')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                ...
                                <div class="form-check-label">@lang('translate.monospace')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-font" value="comic" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.comic')</div>
                            </div>
                        </label>
                    </div>
                </div>
                <div class="mb-4">
                    <label class="form-label">@lang('translate.theme_base')</label>
                    <p class="form-hint">@lang('translate.theme_base_hint')</p>
                    <div>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-base" value="slate" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.slate')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-base" value="gray" class="form-check-input"
                                    checked />
                                <div class="form-check-label">@lang('translate.gray')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-base" value="zinc" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.zinc')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-base" value="neutral" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.neutral')</div>
                            </div>
                        </label>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                                <input type="radio" name="theme-base" value="stone" class="form-check-input" />
                                <div class="form-check-label">@lang('translate.stone')</div>
                            </div>
                        </label>
                    </div>
                </div>
                <div class="mb-4">
                    <label class="form-label">@lang('translate.corner_radius')</label>
                    <p class="form-hint">@lang('translate.corner_radius_hint')</p>
                    <div>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
