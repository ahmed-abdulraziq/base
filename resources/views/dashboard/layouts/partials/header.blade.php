...
<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <svg width="141" height="24" viewBox="0 0 141 35" fill="none"
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0 px-2" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm rounded-circle" @if(auth('admin')->user()->avatar) style="background-image: url('{{ auth('admin')->user()->avatar }}')" @endif>
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        <div class="mt-1 small text-secondary">@lang('translate.' . auth('admin')->user()->role)</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    @foreach (get_available_locales() as $localeCode => $properties)
                        @if ($localeCode == get_current_locale())
                            @continue
                        @endif
                        <li>
                            <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                href="{{ get_locale_url($localeCode) }}">
